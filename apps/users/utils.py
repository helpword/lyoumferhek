...
def get_permissions():
    ...
    excluded_model_names = [
        ...
        'OutstandingToken', 'StockCheckItem', 'PurchaseOrder','HistoricalAbonnementClient', 'StockTransfer', 'Notification',
        ...
        'HistoricalRemunerationProf', 'BasketLine', 'Site','HistoricalAssuranceTransaction','Assurance','Module',
        'Contact','FAQLandingPage','Plan','PlanPrice','Status','TermsLandingPage','Subscription','ClockedSchedule',
        'SubscriptionItem','Domain','Prospect', 'CrontabSchedule' , 'IntervalSchedule', 'PeriodicTask', 'PeriodicTasks',
        'SolarSchedule', 'Business',"LeadSource", "Expense","Income",
    ]
